...
const Header = () => {
  ...
  return (
    ...
    transition={{delay:0.2, duration:0.8}}>
        ...
        <motion.h1 className='text-4xl max-w-75 sm:text-7xl sm:max-w-147.5 mx-auto mt-10 text-center'
         initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        <motion.p className='text-center max-w-xl mx-auto mt-5 font-medium'
        initial={{opacity:0, y:20}}
        animate={{opacity:1, y:0}}
        ...
        >
          {Array(6).fill('').map((item, index)=>(
           ...
           className='rounded hover:scale-70 transition-all duration-300 cursor-pointer max-sm:w-10'
