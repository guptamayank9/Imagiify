  ...
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
      ...
      <div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>
        ...
        <h1 className='text-4xl max-w-75 sm:text-7xl sm:max-w-147.5 mx-auto mt-10 text-center'>
        Turn text to <span className='text-blue-600'>image</span>, in seconds.</h1>

        <p className='text-center max-w-xl mx-auto mt-5 font-medium'
        ...
        <div className='flex flex-wrap justify-center mt-16 gap-3'>
          {Array(6).fill('').map((item, index)=>(
           <img className='rounded hover:scale-70 transition-all duration-300 cursor-pointer max-sm:w-10'
