...
const Login = () => {
  ...
  return (
    <motion.div className='fixed top-0 left-0 right-0 bottom-0
    ...
    viewport={{once:true}}>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' &&  <div className='border px-6 py-2 flex items-center-safe gap-2 rounded-full mt-5'>
            ...
            <div className='border px-6 py-2 flex items-center-safe gap-2 rounded-full mt-4'>
